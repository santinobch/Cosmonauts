...
style='position:absolute;top:190px;right:320px;width:200px;
transform:
rotate(270deg)'
/>
...
<img 
src='http://i.imgur.com/IQENPZX.png'
style='position:absolute;top:240px;right:220px;width:200px;'
/>
...
As a monk you don't have spell slots you instead use your Ki. The ki cost will be detailed on the **Ancient Roots Spells** list below.


If you want to upcast a monk spell you know, you may add the Ki cost of the spell per level upcasted. 
...
At 3rd level you gain knowledge of the *Living Weapon* cantrip and two more cantrips from the druid spell list. 
...
### Ancient Roots Spells
| Lv. in this class | Ki Cost | Spell |
|:----:|:----:|:-------------|
| 3rd | 1 | Barkskin (Source: PHB) |
| 3rd | 1 | Entangle (Source: PHB) |
| 3rd | 1 | Extending Vines |
| 6th | 1 | Caltrops's Spines |
| 6th | 2 | Beetlebomber's Fire Flowers |
| 6th | 2 | Fruity Explotion |
| 6th | 2 | Spike Growth (Source: PHB) |
...
You may move the fist & make another attack using your bonus action.

After the duration the fist dries up and dies. You may only have one *Green Fist* at a time, the spell ends if you cast it again.
...
> - **Challenge** -
> ___
> ***Ancient Link.*** The Green Fist's Strenght modifier becomes your spell ability modifier. It also shares your Proficiency Bonus.
>
...
> * The Art for the Green Fist comes from [Kodama's Reach](https://scryfall.com/card/c17/154/kodamas-reach) a MTG card.
